  ...
  return (
    <View style={[styles.container, style]}>
      ...
      <View
        ...
        {['house-simple', 'chart-line-up'].map((i, idx) => {
          if (idx === 2) {
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  styles.buttonTab,
                  {
                    marginRight: idx === 0 ? 32 : undefined,
                    marginLeft: idx === 1 ? 32 : undefined,
                  },
                ]}>
                <Icon
                  pack="assets"
                  ...
                  style={[
                    styles.icon,
                    {
                      tintColor: index === idx ? '#F6D938' : theme['color-basic-600'],
                    },
                  ]}
                />
                {index === idx && <View style={[styles.dot, { backgroundColor: '#F6D938' }]} />}
              </TouchableOpacity>
            );
          }
        })}
